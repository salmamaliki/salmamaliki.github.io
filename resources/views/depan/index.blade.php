...
<head>
    ...
    <link href="{{ asset('awal') }}/css/styles.css" rel="stylesheet" />
...
<body id="page-top">
        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                ...
                <div class="social-icons">
                    ...
                    <a class="social-icon" href="{{ get_meta_value('_instagram') }}"><i class="fab fa-instagram-f"></i></a>
                </div>
            </div>
        </section>
        <hr class="m-0" />
    ...
    <!-- Core theme JS-->
    <script src="{{ asset('awal') }}/js/scripts.js"></script>
</body>
